        ...
        <main>
          ...
          <div class="flex-column gap">
            <div class="tile">
              ...
              <div>
                <span>{translations.chatPage.message.sentBy}</span>
                <b class="break-word">{chatMessageViewModel.sender}</b>
              </div>
            </div>
            ...
            <div class="tile">
              ...
              <div>
                <span>{translations.chatPage.message.timeSent}</span>
                <b class="break-word">{chatMessageViewModel.dateSent}</b>
              </div>
            </div>
            ...
            <div class="tile">
              ...
              <div>
                <span>{translations.chatPage.message.channel}</span>
                <b class="break-word">{chatMessageViewModel.channel}</b>
              </div>
            </div>
            ...
            <div class="tile">
              ...
              <div>
                <span>{translations.chatPage.message.messageContent}</span>
                <b
                  class="break-word"
